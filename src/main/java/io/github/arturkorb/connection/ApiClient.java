package io.github.arturkorb.connection;

import io.github.arturkorb.auth.ApiKeyAuth;
import io.github.arturkorb.auth.Authentication;
import io.github.arturkorb.auth.HttpBasicAuth;
import io.github.arturkorb.auth.HttpBearerAuth;
import io.github.arturkorb.utils.*;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:5005";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:5005
    ...
    public boolean isYamlMime(String mime) {
        String yamlMime = "(?i)^(application/x-yaml|[^;/ \t]+/[^;/ \t]+[+]yaml)[ \t]*(;.*)?$";
        return mime != null && (mime.matches(yamlMime) || mime.equals("*/*"));
    }
    ...
    public RequestBody serialize(Object obj, String contentType) throws ApiException {
        if (obj instanceof byte[]) {
            ...
            return RequestBody.create(MediaType.parse(contentType), content.getBytes(Charset.forName("UTF-8")));
        } else if (isYamlMime(contentType) && obj instanceof String) {
    ...
    private Interceptor getProgressInterceptor() {
        return new Interceptor() {
            ...
            public Response intercept(Interceptor.Chain chain) throws IOException {
                ...
                Chain overrideChain = chain.withReadTimeout(300, TimeUnit.SECONDS);
                Response originalResponse = overrideChain.proceed(request);
